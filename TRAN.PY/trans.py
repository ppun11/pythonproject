...
#icon
image_icon=PhotoImage(file="C:\\Users\\warcom-pt\\Desktop\\calculator py\\Google_Translate_Icon.png")
root.iconphoto(False,image_icon)

#arrow
arrow_image=PhotoImage(file="C:\\Users\\warcom-pt\\Desktop\\calculator py\\images (2).png")
image_label=Label(root,image=arrow_image,width=100,height=50)
image_label.place(x=475,y=150)
